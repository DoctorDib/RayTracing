...
public class RayTracer {
    ...
    public static void main(String [] args) {
        ...
        // light
        spheres.add(new Sphere(new Vec3(10, 10, -25), 3,
                new RGB(0, 0, 0), 0, 0, new RGB(3, 3, 3)));

        // HEAD
        spheres.add(new Sphere(new Vec3(-0, 0, -75), 10,
                new RGB(1, 0.10, 0.10), 1, 0.0));

        // EYE - LEFT
        spheres.add(new Sphere(new Vec3(-5, 10, -30), 5,
                new RGB(0.25, 0.1, 1), 1, 0.0));
        // EYE - RIGHT
        spheres.add(new Sphere(new Vec3(5, 8, -40), 4,
                new RGB(0.1, 0.25, 1), 1, 0.0));

        // NOSE
        spheres.add(new Sphere(new Vec3(0, 0, -70), 0.5,
                new RGB(0.75, 0, 0.75), 1, 0.0));

        // MOUTH - LEFT TO RIGHT
        spheres.add(new Sphere(new Vec3(-11, -2, -40), 3,
                new RGB(1, 1, 0.1),  0.5, 0.0));
        spheres.add(new Sphere(new Vec3(-7, -6, -30), 3.5,
                new RGB(0.6, 1, 0.2), 0.5, 0.0));
        spheres.add(new Sphere(new Vec3(0, -9, -20), 4,
                new RGB(0.2, 1, 0), 0.5, 0.0));
        spheres.add(new Sphere(new Vec3(7, -6, -30), 3.5,
                new RGB(0.6, 1, 0.2), 0.5, 0.0));
        spheres.add(new Sphere(new Vec3(11, -2, -40), 3,
                new RGB(1, 1, 0.1), 0.5, 0.0));
        ...
        // RANDOM OBJECTS
        spheres.add(new Sphere(new Vec3(50, 0, -400), 100,
                new RGB(1, 0.5, 0.5), 0.5, 0.5));
        spheres.add(new Sphere(new Vec3(-50, 0, -400), 95,
                new RGB(0, 1, 1), 1, 0.75));
